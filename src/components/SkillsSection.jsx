...
const skills = [
    // Electrical
    {name: 'Circuit Design', level: 95, category: 'electrical'},
    {name: 'PCB Design', level: 90, category: 'electrical'},
    {name: 'Soldering', level: 90, category: 'electrical'},
    {name: 'Real-time Signal Processing', level: 70, category: 'electrical'},
    ...
    {name: 'Verilog', level: 75, category: 'programming'},
    
    // Tools
    {name: 'Git/Github', level: 90, category: 'tools'},
    {name: 'VS Code', level: 95, category: 'tools'},
    {name: 'SoldWorks', level: 80, category: 'tools'},
